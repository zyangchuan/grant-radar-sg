...
import { Loader2, Building, Pencil, Mail, Globe, Users, DollarSign, Target } from "lucide-react";
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <Card className="md:col-span-2">
            <CardHeader>
                ...
                <CardDescription>Registration ID: {org.registration_id}</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground whitespace-pre-line">{org.mailing_address}</p>
                </div>
            </CardContent>
        </Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    {org.organization_website && (
                         <div className="flex items-center gap-3">
                            ...
                            <a href={org.organization_website} target="_blank" rel="noopener noreferrer" className="text-sm hover:underline col-span-2 truncate">
                                Website
                            </a>
                        </div>
                    )}
